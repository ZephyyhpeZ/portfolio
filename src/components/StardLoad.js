...
const StardLoad = () => {
  ...
  return (
    <div className="Transition">
      <m.div
        className="fixed top-0 h-screen w-screen bg-[#7D49D9] z-[9970] pointer-events-none"
        initial={{
          clipPath:
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <m.path
              d="M44.2887 48V0H23V48H44.2887Z"
              initial={{ fill: '#000000' }}
              animate={{ fill: '#7D49D9' }}
              transition={{
                delay: 4.6,
